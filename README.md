...
前端 (Frontend)
React, MapLibre GL, Leaflet, Axios, Vite
後端 (Backend)
Python 3.9+, FastAPI, Uvicorn, Pydantic
空間資料處理 (Geospatial)
TiTiler, Rasterio, GDAL, Cloud Optimized GeoTIFF (COG)
部署與開發 (DevOps)
...
git clone https://github.com/AuroraShiao/NASA-Ultra-High-Resolution-Imagery-Cloud-Interactive-Platform.git
